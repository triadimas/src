 ...
 */
#ifndef UDP_ECHO_HELPER2_H
#define UDP_ECHO_HELPER2_H
...
public:
   ...
   */
  UdpEchoServerHelper2 (uint16_t port);
...
public:
   ...
   */
  UdpEchoClientHelper2 (Address ip, uint16_t port);
  UdpEchoClientHelper2 (Ipv4Address ip, uint16_t port);
  UdpEchoClientHelper2 (Ipv6Address ip, uint16_t port);
